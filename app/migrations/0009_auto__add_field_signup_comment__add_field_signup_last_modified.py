...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Signup.comment'
        db.add_column('app_signup', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True), keep_default=False)

        # Adding field 'Signup.last_modified'
        db.add_column('app_signup', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 12, 6, 22, 28, 45, 606000), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Signup.comment'
        db.delete_column('app_signup', 'comment')

        # Deleting field 'Signup.last_modified'
        db.delete_column('app_signup', 'last_modified')
