...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_event', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 12, 1, 14, 11, 45, 725000), blank=True), keep_default=False)

        # Adding field 'Event.created'
        db.add_column('app_event', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 12, 1, 14, 11, 54, 509000), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.last_modified'
        db.delete_column('app_event', 'last_modified')

        # Deleting field 'Event.created'
        db.delete_column('app_event', 'created')
