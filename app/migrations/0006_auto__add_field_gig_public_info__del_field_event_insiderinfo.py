...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gig.public_info'
        db.add_column('app_gig', 'public_info', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'Event.insiderinfo'
        db.delete_column('app_event', 'insiderinfo')


    def backwards(self, orm):
        
        # Deleting field 'Gig.public_info'
        db.delete_column('app_gig', 'public_info')

        # Adding field 'Event.insiderinfo'
        db.add_column('app_event', 'insiderinfo', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
