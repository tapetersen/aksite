...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Medal'
        db.create_table('app_medal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('app', ['Medal'])

        # Adding field 'Gig.secret'
        db.add_column('app_gig', 'secret', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Medal'
        db.delete_table('app_medal')

        # Deleting field 'Gig.secret'
        db.delete_column('app_gig', 'secret')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 7, 13, 4, 22, 24000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 7, 13, 4, 22, 24000)'}),
