...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.only_public'
        db.add_column('page_page', 'only_public', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Page.only_public'
        db.delete_column('page_page', 'only_public')
    ...
    models = {
        ...
        'page.rsscontent': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'RSSContent', 'db_table': "'page_page_rsscontent'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'max_items': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rsscontent_set'", 'to': "orm['page.Page']"}),
            'region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
